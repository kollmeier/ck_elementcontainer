...
$GLOBALS['TL_DCA']['tl_ckelementcontainer_elements'] = array
(
	...
	(
		...
		(
			...
			'child_record_callback'   => array('tl_ckelementcontainer_elements', 'listFormFields')
		),
		'label' => array
		(
			'fields'                  => array('title'),
		...
		(
			'edit' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['edit'],
				'href'                => 'act=edit',
				'icon'                => 'edit.gif'
			),
			'copy' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['copy'],
				'href'                => 'act=paste&amp;mode=copy',
				'icon'                => 'copy.gif'
			),
			'cut' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['cut'],
			...
			'delete' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['delete'],
				'href'                => 'act=delete',
				'icon'                => 'delete.gif',
			...
			'show' => array
			(
				'label'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['show'],
				'href'                => 'act=show',
				'icon'                => 'show.gif'
			)
		)
	...
	'type' => array
	  (
      'label'     => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['type'],
      'reference'     => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['type_select'],
      'inputType' => 'select',
      ...
      'default' => 'text',
      'exclude' => true,
      'load_callback'        => array(array('tl_ckelementcontainer_elements','loadTypeField')),
      'eval' => array('submitOnChange' => true, 'tl_class' => 'w50')
    ),
		'label' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['label'],
			'inputType'             => 'text',
			'exclude'				=> true,
		...
		'title' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['title'],
			'inputType'             => 'text',
			'exclude'				=> true,
			'eval'                    => array('rgxp'=>'alnum', 'doNotCopy'=>true, 'spaceToUnderscore'=>true, 'maxlength'=>128, 'tl_class'=>'w50'),
			'save_callback' => array
			(
				array('tl_ckelementcontainer_elements', 'generateTitle')
			)
		),
		'explanation' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['explanation'],
			'inputType'             => 'text',
			'exclude'				=> true,
		...
		'default_value' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['default_value'],
			'inputType'             => 'text',
			'exclude'				=> true,
		...
		'options' => array
		(
      'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['options'],
      ...
      'eval'                  => array('tl_class' => 'clr','multiple' => true)
		...
		'hidden' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['hidden'],
			'inputType'             => 'checkbox',
			'exclude'				=> true,
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_mandatory'],
			'inputType'             => 'checkbox',
			'exclude'				=> true,
		...
		'eval_rgxp' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_rgxp'],
			'reference'             => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_rgxp_select'],
			'inputType'             => 'select',
			'options'                => array('digit',
                                        'alpha',
                                        'alnum',
...
//                                        'friendly',
		...
		'eval_rte' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_rte'],
			'inputType'             => 'checkbox',
			'exclude'				=> true,
	  ...
	  'eval_tl_class' => array
	  (
      'label'     => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_tl_class'],
      'reference'     => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_tl_class_options'],
      'inputType' => 'checkbox',
      ...
      'eval' => array('tl_class'=>'w50 clr', 'multiple' => true)
		...
		'eval_rows' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_rows'],
			'default'              => 5,
			'inputType'             => 'text',
			'exclude'				=> true,
		...
		'eval_cols' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_cols'],
			'default'              => 100,
			'inputType'             => 'text',
			'exclude'				=> true,
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_minlength'],
			'default'              => 0,
			'inputType'             => 'text',
			'exclude'				=> true,
			'eval'                  => array('mandatory'=>true, 'maxlength'=>3, 'tl_class'=>'w50 clr', 'rgxp' => 'digit')
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_maxlength'],
			'default'              => '',
			'inputType'             => 'text',
			'exclude'				=> true,
		...
		(
		  'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_field_type'],
		  'default'               => 'ft_radio',
		  'inputType'             => 'radio',
		...
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_extensions'],
			'inputType'             => 'text',
			'exclude'				        => true,
			'eval'                  => array('maxlength'=>255, 'tl_class'=>'w50 clr')
		),
		'eval_path' => array
		(
		  'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_path'],
		  'default'               => '',
		  'inputType'             => 'fileTree',
		  'exclude'               => true,
		...
		'exclude' => array
		(
		  'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['exclude'],
		  'inputType'             => 'checkbox',
		  'exclude'               => true,
		...
		(
		  'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_allow_html'],
		  'inputType'             => 'checkbox',
		  'exclude'               => true,
		  'eval'                  => array('tl_class' => 'w50')
    ),
        'eval_blank_option' => array(
            'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_blank_option'],
            'inputType'             => 'checkbox',
        	'exclude'               => true,
        	'eval'                  => array('tl_class' => 'w50')
        ),
        'eval_chosen' => array(
            'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_chosen'],
            'inputType'             => 'checkbox',
        	'exclude'               => true,
        	'eval'                  => array('tl_class' => 'w50')
        ),
		'eval_unique' => array
		(
		  'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_unique'],
		  'inputType'             => 'checkbox',
		  'exclude'               => true,
		  'eval'                  => array('tl_class' => 'w50 clr')
    ),
		...
		(
		  'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_do_not_copy'],
		  'inputType'             => 'checkbox',
		  'exclude'               => true,
		  'eval'                  => array('tl_class' => 'w50')
    ),
    'eval_sortable' => array
    (
    	'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['eval_sortable'],
		  'inputType'             => 'checkbox',
		  'exclude'               => true,
		  'eval'                  => array('tl_class' => 'w50')
    ),
		'class' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['class'],
			'inputType'             => 'text',
			'exclude'				        => true,
		...
		'template' => array
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ckelementcontainer']['template'],
			'default'                 => 'dma_egfield_default',
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_ckelementcontainer_elements','getElementTemplates'),
			'eval'                    => array('tl_class'=>'w50')
		),
		'hyperlink_data' => array
		(
			'label' 									=> &$GLOBALS['TL_LANG']['tl_ckelementcontainer_fiels']['hyperlink_data'],
			'exclude' 								=> true,
			'inputType'               => 'checkbox',
			'options'                 => array('url','target','linkTitle','rel','embed'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['hyperlink_data_options'],
			'eval'                    => array('multiple'=>true, 'tl_class'=>'clr')
		),
		'image_data' => array
		(
			'label' 									=> &$GLOBALS['TL_LANG']['tl_ckelementcontainer_fiels']['image_data'],
			'exclude' 								=> true,
			'inputType'               => 'checkbox',
			'options'                 => array('singleSRC','alt','title','size','imagemargin','imageUrl','fullsize','caption','floating'),
			'reference'               => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['image_data_options'],
			'eval'                    => array('multiple'=>true, 'tl_class'=>'clr')
		),
		'useCheckboxCondition' => array
		(
			'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['useCheckboxCondition'],
			'exclude'               => true,
			'inputType'             => 'checkbox',
		...
		(
			'label'                   => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['subpaletteSelector'],
			'default'                 => '',
			'exclude'                 => true,
			'inputType'               => 'select',
			'options_callback'        => array('tl_ckelementcontainer_elements','getCheckboxelements'),
			'eval'                    => array('includeBlankOption'=>true, 'tl_class'=>'w50')
		),
        'renderHiddenData' => array
        (
            'label'                 => &$GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['renderHiddenData'],
            'exclude'               => true,
            'inputType'             => 'checkbox',
        ...
        'optionsType' => array
        (
           'label' => &$GLOBALS['TL_LANG']['tl_ckelementcontainer']['optionsType'],
            'default' => 'manual',
            'exclude' => true,
            'inputType' => 'select',
        ...
        'optDbTable' => array(
            'label' => &$GLOBALS['TL_LANG']['tl_ckelementcontainer']['optDbTable'],
            'default' => '',
            'exclude' => true,
            'inputType' => 'select',
            'options_callback' => array('tl_ckelementcontainer_elements','getDatabaseTables'),
            'eval' => array('includeBlankOption'=>true,'mandatory'=> true, 'submitOnChange' => true, 'tl_class'=>'w50 clr')
        ),
        'optDbQuery' => array(
            'label' => &$GLOBALS['TL_LANG']['tl_ckelementcontainer']['optDbQuery'],
            'exclude' => true,
            'inputType' => 'textarea',
            'eval'      => array('preserveTags'=>true, 'style'=>'height:60px', 'tl_class'=>'clr'),
        ),
        'optDbTitle' => array(
            'label' => &$GLOBALS['TL_LANG']['tl_ckelementcontainer']['optDbTitle'],
            'default' => '',
            'exclude' => true,
            'inputType' => 'select',
            'options_callback' => array('tl_ckelementcontainer_elements','getDatabaseTableRows'),
            'eval' => array('includeBlankOption'=>true,'tl_class'=>'w50')
        )
	)
);
...
class tl_ckelementcontainer_elements extends Backend
{
	/**
    ...
    public function loadTypeField($varValue, DataContainer $dc)
    {
        ...
        {
            $GLOBALS['TL_DCA']['tl_ckelementcontainer_elements']['fields']['type']['eval']['disabled'] = true;
            $GLOBALS['TL_DCA']['tl_ckelementcontainer_elements']['fields']['type']['label'] = $GLOBALS['TL_LANG']['tl_ckelementcontainer_elements']['type_disabled'];
        }
        return $varValue;
    }
	...
	public function generateTitle($varValue, DataContainer $dc)
	{
		...
		// Generate alias if there is none
			$objTitle = $this->Database->prepare("SELECT label,pid FROM tl_ckelementcontainer_elements WHERE id=?")
									   ->limit(1)
									   ->execute($dc->id);
		if (!strlen($varValue))
		{
		...
		$objAlias = $this->Database->prepare("SELECT id FROM tl_ckelementcontainer_elements WHERE id=? AND pid=? AND title=?")
	...
	{
		$objCheckboxes = $this->Database->prepare("SELECT * FROM tl_ckelementcontainer_elements WHERE pid=? AND type=?")
